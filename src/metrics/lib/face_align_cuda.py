...
predictor_path = 'checkpoint/AED/shape_predictor_5_face_landmarks.dat'
image_root_path = ''
save_root_path = ''
...
cnn_face_detector = dlib.cnn_face_detection_model_v1('checkpoint/AED/mmod_human_face_detector.dat')
...
def main(img_dir,face_dir):
    image_root_path=img_dir
    save_root_path=face_dir
    cnt = 0
